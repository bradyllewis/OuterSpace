...
- (void)viewDidLoad
{
    ...
    for (NSMutableDictionary *planetData in [AstronomicalData allKnownPlanets]){
        ...
        OWObject *planet = [[OWObject alloc] initWithData:planetData andImage:[UIImage imageNamed:imageName]];
...
-(void)prepareForSegue:(UIStoryboard *)segue sender:(id)sender
{
    if ([sender isKindOfClass:[UITableViewCell class]])
    {
        if ([segue.destinationViewController isKindOfClass:[OWSpaceImageViewController class]])
        {
            ...
            OWObject *selectedObject = self.planets[path.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    OWObject *planet = [self.planets objectAtIndex:indexPath.row];
